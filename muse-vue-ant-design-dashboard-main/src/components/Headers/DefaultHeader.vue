<template>
	...
	<a-layout-header>
		<div  class="text-center">
			<a-col class="col-img">
				<div class="default-header__brand">
					<img class="default-header__logo" src="images/otra.png" alt="Olanchito Bilingual School" />
					<h6 class="default-header__title">Olanchito Bilingual School</h6>
				</div>
		...
		<!-- <div class="header-col header-nav">
			...
			<!-- <a-menu mode="horizontal" class="menu-large">
				...
				<a-menu-item>
					<router-link to="/registro/alumnos" class="nav-link" @click="e => e.preventDefault()">
